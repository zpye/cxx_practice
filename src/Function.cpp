...
void test_function()
{
    cout << "==========STL function==========" << endl;
    {
        ...
        function< int(int, string) > f2(func2);
    ...
    cout << "==========bind==========" << endl;
    {
        function< void(int, int) > f3 = 
            bind(func3, placeholders::_2, 7, placeholders::_1, 8);
        function< void(int) > f4 =
            bind(func3, placeholders::_1, 10, placeholders::_1, placeholders::_1);
    ...
    {
        F f;
        function< void() > f5 = bind(func4, F());
        function< void() > f6 = bind(func4, f);
        function< void() > f7 = []() { func4(F()); };
        function< void() > f8 = [=]() { func4(f); };
        function< void() > f9 = [&]() { func4(f); };
